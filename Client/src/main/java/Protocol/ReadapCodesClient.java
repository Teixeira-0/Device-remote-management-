...
public class ReadapCodesClient {
    ...
    public static final byte REMOTESTART = 2;
    public static final byte REMOTECOMMAND = 3;
    public static final byte REMOTECOMMANDMESSAGE = 4;
    public static final byte REMOTECOMMANDEND = 5;
    public static final byte REMOTEACK = 6;

...
class ConnectionControllerTest {
    ...
    void testSuccessFullConection() {
        ...
        Mockito.when(connectionHandler.handleConnectionRequest("localhost", 61010)).thenReturn("success");
    ...
    void testCertificateErrorConection() {
        ...
        // Mock the behavior of the connection handler to return the mock socket
        Mockito.when(connectionHandler.handleConnectionRequest("localhost", 61010)).thenReturn("certificate");
    ...
    void testHostErrorConection() {
        ...
        // Mock the behavior of the connection handler to return the mock socket
        Mockito.when(connectionHandler.handleConnectionRequest("localhost", 61010)).thenReturn("host");
    ...
    void testPortErrorConection() {
        ...
        // Mock the behavior of the connection handler to return the mock socket
        Mockito.when(connectionHandler.handleConnectionRequest("localhost", 61010)).thenReturn("port");
